package com.miguigongal.todo_app_backend.rest.dtos;
...
public class UserConversor {
	...
	public final static UserDto toUserDto(User user) {
		return new UserDto(user.getId(), user.getUserName(), user.getFirstName(), user.getLastName(), user.getEmail(), user.getRole().toString());
	}
